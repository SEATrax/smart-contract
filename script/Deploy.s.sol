...
contract DeployScript is Script {
    ...
    function generateDeploymentArtifacts() internal view {
        ...
        console.log("# Verify PlatformAccessControl:");
        console.log("forge verify-contract --rpc-url https://rpc.sepolia-api.lisk.com \\");
        console.log("  --verifier blockscout --verifier-url 'https://sepolia-blockscout.lisk.com/api/' \\");
        console.log("  ", accessControl, " src/AccessControl.sol:PlatformAccessControl");
        console.log("");
        console.log("# Verify InvoiceNFT:");
        console.log("forge verify-contract --rpc-url https://rpc.sepolia-api.lisk.com \\");
        console.log("  --verifier blockscout --verifier-url 'https://sepolia-blockscout.lisk.com/api/' \\");
        console.log("  --constructor-args $(cast abi-encode 'constructor(address)' ", accessControl, ") \\");
        console.log("  ", invoiceNFT, " src/InvoiceNFT.sol:InvoiceNFT");
        console.log("");
        console.log("# Verify PoolNFT:");
        console.log("forge verify-contract --rpc-url https://rpc.sepolia-api.lisk.com \\");
        console.log("  --verifier blockscout --verifier-url 'https://sepolia-blockscout.lisk.com/api/' \\");
        console.log("  --constructor-args $(cast abi-encode 'constructor(address,address)' ", accessControl, " ", invoiceNFT, ") \\");
        console.log("  ", poolNFT, " src/PoolNFT.sol:PoolNFT");
        console.log("");
        console.log("# Verify PoolFundingManager:");
        console.log("forge verify-contract --rpc-url https://rpc.sepolia-api.lisk.com \\");
        console.log("  --verifier blockscout --verifier-url 'https://sepolia-blockscout.lisk.com/api/' \\");
        console.log("  --constructor-args $(cast abi-encode 'constructor(address,address,address)' ", accessControl, " ", invoiceNFT, " ", poolNFT, ") \\");
        console.log("  ", poolFundingManager, " src/PoolFundingManager.sol:PoolFundingManager");
        console.log("");
        console.log("# Verify PaymentOracle:");
        console.log("forge verify-contract --rpc-url https://rpc.sepolia-api.lisk.com \\");
        console.log("  --verifier blockscout --verifier-url 'https://sepolia-blockscout.lisk.com/api/' \\");
        console.log("  --constructor-args $(cast abi-encode 'constructor(address,address,address,address)' ", accessControl, " ", invoiceNFT, " ", poolNFT, " ", poolFundingManager, ") \\");
        console.log("  ", paymentOracle, " src/PaymentOracle.sol:PaymentOracle");
        console.log("");
        console.log("# Verify PlatformAnalytics:");
        console.log("forge verify-contract --rpc-url https://rpc.sepolia-api.lisk.com \\");
        console.log("  --verifier blockscout --verifier-url 'https://sepolia-blockscout.lisk.com/api/' \\");
        console.log("  --constructor-args $(cast abi-encode 'constructor(address,address,address,address,address)' ", accessControl, " ", invoiceNFT, " ", poolNFT, " ", poolFundingManager, " ", paymentOracle, ") \\");
        console.log("  ", platformAnalytics, " src/PlatformAnalytics.sol:PlatformAnalytics");
        console.log("=====================");
    }
}